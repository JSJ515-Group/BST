...
from model.semseg.attdeeplabv3plus import attDeepLabV3Plus
from model.semseg.pspnet import PSPNet
from model.semseg.unet import UNet
from model.semseg.attpspnet import attPSPNet
from model.semseg.attdeep import attDeep
from model.semseg.odconvdeeplab import odconvDeepLab
...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, choices=['pascal', 'cityscapes'], default='cityscapes')
    parser.add_argument('--batch-size', type=int, default=6)
    parser.add_argument('--lr', type=float, default=None)
    parser.add_argument('--epochs', type=int, default=None)
    parser.add_argument('--crop-size', type=int, default=None)
    parser.add_argument('--backbone', type=str, choices=['resnet50', 'resnet101'], default='resnet50')
    parser.add_argument('--model', type=str, choices=['deeplabv3plus', 'pspnet', 'deeplabv2', 'attdeeplabv3plus', 'unet','attPSPNet', 'attDeep', 'odconvDeepLab'],
                        default='attDeep')
...
def init_basic_elems(args):
    model_zoo = {'deeplabv3plus': DeepLabV3Plus, 'pspnet': PSPNet, 'deeplabv2': DeepLabV2, 'attdeeplabv3plus': attDeepLabV3Plus, 'unet': UNet, 'attPSPNet': attPSPNet, 'attDeep': attDeep, 'odconvDeepLab': odconvDeepLab}
...
if __name__ == '__main__':
    ...
    if args.epochs is None:
        args.epochs = {'pascal': 100, 'cityscapes': 240}[args.dataset]
    if args.lr is None:

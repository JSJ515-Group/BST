...
from model.semseg.odconv import ODConv2d


class odconvDeepLab(BaseNet):
    def __init__(self, backbone, nclass):
        super(odconvDeepLab, self).__init__(backbone)
...
def ASPPConv(in_channels, out_channels, atrous_rate):
    block = nn.Sequential(ODConv2d(in_channels, out_channels, 3, padding=atrous_rate, dilation=atrous_rate),

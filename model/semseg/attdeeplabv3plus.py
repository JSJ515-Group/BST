...
from model.semseg.attention import cbam_block


class attDeepLabV3Plus(BaseNet):
    def __init__(self, backbone, nclass):
        super(attDeepLabV3Plus, self).__init__(backbone)
        ...
        # 添加CBAM注意力模块
        self.Attention = cbam_block(high_level_channels // 8 + 48)
...
class ASPPModule(nn.Module):
    def __init__(self, in_channels, atrous_rates):
        ...
        # 添加CBAM注意力模块
        self.ASPPAttention = cbam_block(5 * out_channels)

...
from model.semseg.BCEA import BCEA


class attDeep(BaseNet):
    def __init__(self, backbone, nclass):
        super(attDeep, self).__init__(backbone)
        ...
        # 添加BCEA注意力模块
        self.bcea = BCEA(high_level_channels // 8 + 48)
...
class ASPPModule(nn.Module):
    def __init__(self, in_channels, atrous_rates):
        ...
        # 添加bcea注意力模块
        self.ASPPAttention = BCEA(5 * out_channels)
